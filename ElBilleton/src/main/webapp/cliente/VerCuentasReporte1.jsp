...
<html>
    ...
    <body>
        ...
        <form method="GET" action="VerCuentasReporte1">
                ...
                <table id="customers">
                    ...
                    <c:forEach items="${listaCuentas}" var="cuenta">
                        <tr>
                            ...
                            <td>
                                <a class="button" href="${pageContext.request.contextPath}/GenerarReporte1Cliente?cuenta=${cuenta.getCodigo()}&&cliente=${cuenta.getCliente_codigo()}">Seleccionar</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
