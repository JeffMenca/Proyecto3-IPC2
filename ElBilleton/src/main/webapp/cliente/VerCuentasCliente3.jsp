...
<html>
    ...
    <body>
        ...
        <form method="GET" action="VerCuentasCliente3">
                ...
                <table id="customers">
                    ...
                    <c:forEach items="${listaCuentas}" var="cuenta">
                        <tr>
                            ...
                            <td>
                                <a class="button" href="${pageContext.request.contextPath}/VerEstadoCuenta?cuenta=${cuenta.getCodigo()}&&cliente=${cuenta.getCliente_codigo()}">Seleccionar</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
