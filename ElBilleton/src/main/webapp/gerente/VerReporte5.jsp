...
<html>
    ...
    <body>
        ...
        <form method="GET" action="${pageContext.request.contextPath}/exportarReporte5">

            <br> <br> <br> <br> <br> <br> <br> 

            <div class="container">
                <h1 style="color:WHITE">Ver los clientes que no han realizado transacciones
                    dentro de un intervalo de tiempo</h1>
                <br> <br>
