...
<html>
    ...
    <body>
        ...
        <form method="GET" action="${pageContext.request.contextPath}/exportarReporte2">

            <br> <br> <br> <br> <br> <br> <br> 

            <div class="container">
                <h1 style="color:WHITE">Ver clientes con transacciones monetarias mayores
                ...
                <table id="customers">
                    ...
                    <c:forEach items="${listaCliente}" var="cliente">
                        <tr>
                            ...
                            <td>
                                <a class="button" href="${pageContext.request.contextPath}/VerTransaccionesReporte2?codigo=${cliente.getCodigo()}">Ver transacciones</a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
