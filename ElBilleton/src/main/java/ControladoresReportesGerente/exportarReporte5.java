 ...
 * @author jeffrey
 */
@WebServlet(name = "exportarReporte5", urlPatterns = {"/exportarReporte5"})
public class exportarReporte5 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = request.getServletContext().getRealPath("/resources/reporte5.jasper");
