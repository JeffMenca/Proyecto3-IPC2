 ...
 * @author jeffrey
 */
@WebServlet(name = "exportarReporte3", urlPatterns = {"/exportarReporte3"})
public class exportarReporte3 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = request.getServletContext().getRealPath("/resources/reporte3.jasper");
