 ...
 * @author jeffrey
 */
@WebServlet(name = "exportarReporteCliente3Trans", urlPatterns = {"/exportarReporteCliente3Trans"})
public class exportarReporteCliente3Trans extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        try {
            Long codigo = Long.valueOf((String) request.getParameter("cuenta"));
            Date fecha1 = Date.valueOf((String) request.getParameter("fecha1"));
            Date fecha2 = Date.valueOf(LocalDate.now());
            Map parametro = new HashMap();
            parametro.put("cuenta", codigo);
            parametro.put("fecha1", fecha1);
            parametro.put("fecha2", fecha2);
            JasperReport reporte = null;
            String path = request.getServletContext().getRealPath("/resources/ReporteCliente3Trans.jasper");
