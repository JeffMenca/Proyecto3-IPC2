 ...
 * @author jeffrey
 */
@WebServlet(name = "exportarReporte2", urlPatterns = {"/exportarReporte2"})
public class exportarReporte2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String path = request.getServletContext().getRealPath("/resources/reporte2.jasper");
