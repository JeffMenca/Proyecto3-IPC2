 ...
 * @author jeffrey
 */
@WebServlet(name = "VerCuentasReporte1", urlPatterns = {"/VerCuentasReporte1"})
public class VerCuentasReporte1 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/cliente/VerCuentasReporte1.jsp").forward(request, response);
