 ...
 * @author jeffrey
 */
@WebServlet(name = "VerCuentasReporte4", urlPatterns = {"/VerCuentasReporte4"})
public class VerCuentasReporte4 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/cliente/VerCuentasReporte4.jsp").forward(request, response);
