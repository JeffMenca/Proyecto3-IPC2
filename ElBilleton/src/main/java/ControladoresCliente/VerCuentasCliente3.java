 ...
 * @author jeffrey
 */
@WebServlet(name = "VerCuentasCliente3", urlPatterns = {"/VerCuentasCliente3"})
public class VerCuentasCliente3 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/cliente/VerCuentasCliente3.jsp").forward(request, response);
