 ...
 * @author jeffrey
 */
@WebServlet(name = "VerSolicitudesPendientes", urlPatterns = {"/VerSolicitudesPendientes"})
public class VerSolicitudesPendientes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList cuentas = solicitudModel.obtenerSolicitudesPendiente(cuentaSeleccionada);
            request.setAttribute("solicitudes", cuentas);
