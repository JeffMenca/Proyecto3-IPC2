 ...
 * @author jeffrey
 */
@WebServlet(name = "VerCuentasCliente2", urlPatterns = {"/VerCuentasCliente2"})
public class VerCuentasCliente2 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/cliente/VerCuentasCliente2.jsp").forward(request, response);
