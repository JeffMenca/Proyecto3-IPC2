 ...
 * @author jeffrey
 */
@WebServlet(name = "SeleccionarCuentasDeposito", urlPatterns = {"/SeleccionarCuentasDeposito"})
public class SeleccionarCuentasDeposito extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (cuentaEncontrada != null) {
                ...
                request.getRequestDispatcher("/cajero/ErrorEncontrarCuenta.jsp").forward(request, response);
            }
