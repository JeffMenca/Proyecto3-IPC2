 ...
 * @author jeffrey
 */
@WebServlet(name = "GenerarReporte4", urlPatterns = {"/GenerarReporte4"})
public class GenerarReporte4 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList clientes = clienteModel.obtenerReporte4();
            request.setAttribute("listaClientes", clientes);
            request.getRequestDispatcher("/gerente/VerReporte4.jsp").forward(request, response);
        } catch (Exception e) {
