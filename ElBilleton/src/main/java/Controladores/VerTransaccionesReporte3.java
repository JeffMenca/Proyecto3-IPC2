 ...
 * @author jeffrey
 */
@WebServlet(name = "VerTransaccionesReporte3", urlPatterns = {"/VerTransaccionesReporte3"})
public class VerTransaccionesReporte3 extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList transacciones = modelTransaccion.obtenerTransaccionLimite(limites.getLimite_reporte3(), codigoCliente);
