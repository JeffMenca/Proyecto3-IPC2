 ...
 * @author jeffrey
 */
@WebServlet(name = "CargarEditarCliente", urlPatterns = {"/CargarEditarCliente"})
public class CargarEditarCliente extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            Cliente cliente=clienteModel.obtenerCliente(codigo);
            String password=cliente.getPassword();
            cliente.setPassword(Encriptar.desencriptar(password));
