 ...
 * @author jeffrey
 */
@WebServlet(name = "VerEditarClientes", urlPatterns = {"/VerEditarClientes"})
public class VerEditarClientes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/gerente/VerEditarCliente.jsp").forward(request, response);
        } catch (Exception e) {
        }
