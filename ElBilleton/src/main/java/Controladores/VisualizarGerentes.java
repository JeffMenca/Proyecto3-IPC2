 ...
 * @author jeffrey
 */
@WebServlet(name = "VisualizarGerentes", urlPatterns = {"/VisualizarGerentes"})
public class VisualizarGerentes extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/gerente/VisualizarGerentes.jsp").forward(request, response);
        } catch (Exception e) {
        }
    }
