...
<html>
    ...
    <center><h1 style="color:white;">Error</h1></h1></center>
    <br> 
    <center><div style="color:red;">
            
            <strong><p>No es posible acceder a esa funcion porque no se encuentra</p>
                <p>dentro del horario de su turno</p></strong>
        </div></center>
